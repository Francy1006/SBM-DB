...
(code, price_configuration, franchise_configuration, variable_formula, price_type, is_deleted, is_confirmed, created_at, updated_at, confirmed_at, deleted_at, created_by, confirmed_by, updated_by, deleted_by)

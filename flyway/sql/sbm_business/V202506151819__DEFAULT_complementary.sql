...
VALUES
('GRANEL', 'ENVASE CON CONTENIDO A GRANEL', true);
INSERT INTO
    sbm_business.item_group (group_name, description, catalog_render)
VALUES
('UNIDAD', 'UNIDAD', false);
...
INSERT INTO
    sbm_business.item_group (group_name, description, catalog_render)
VALUES
('SERVICIO', 'SERVICIO INTERNO O EXTERNO', false);
-- ITEM-CATEGORY
INSERT INTO
    sbm_business.item_category (category, description, catalog_render)
VALUES
    ('PASTA', 'PRODUCTO PASTA LISA O RELLENA', true);
INSERT INTO
    sbm_business.item_category (category, description, catalog_render)
VALUES
    ('SALSA', 'PRODUCTO SALSA PARA PASTA', true);
INSERT INTO
    sbm_business.item_category (category, description, catalog_render)
VALUES
    ('BEBESTIBLE', 'PRODUCTO BEBIDA O AGUA FRIA', false);
INSERT INTO
    sbm_business.item_category (category, description, catalog_render)
VALUES
    (
...
INSERT INTO
    sbm_business.item_category (category, description, catalog_render)
VALUES
    ('PASTELERIA', 'PRODUCTO PASTELERIA', false);
INSERT INTO
    sbm_business.item_category (category, description, catalog_render)
VALUES
    ('SANDWICH', 'PRODUCTO SANDWICH', false);
INSERT INTO
    sbm_business.item_category (category, description, catalog_render)
VALUES
    (
